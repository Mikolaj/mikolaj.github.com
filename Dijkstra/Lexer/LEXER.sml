...
in
   ...
   enough SML *)
    ...
    val map : Cutter.sentence * ( Counter.Number.number -> Tokens.token ) * 
	( Recognizer.Word.word -> Tokens.token ) -> InfoAndTokenList.info_and_token_list
...
(* SML
   ...
   enough SML *)
    ...
    val lex : Cutter.CharList.char_list -> InfoAndTokenList.info_and_token_list
